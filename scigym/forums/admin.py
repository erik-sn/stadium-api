...
class MessageBoardAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'description', 'tags', 'author', 'environment')

    fields = ('title', 'description', 'tags', 'author', 'environment')

    search_fields = ['title', 'description', 'tags', 'author', 'environment']
